...
An energy contract defines the boundaries of interactions between two or more systems within an energy ecosystem. Here, "systems" broadly refer to various entities, including natural or legal entities, devices (e.g., electric vehicles, meters, sensors), or software applications (e.g., trading platforms, user wallets).
...
In every interaction, one party seeks something, and another party provides it. An energy contract typically comprises two fundamental components: Energy intent and Energy catalogue 
